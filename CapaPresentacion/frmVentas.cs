...
namespace CapaPresentacion
{
    public partial class frmVentas : Form
    {
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La cantidad no puede ser mayor al stock", "Mensaje0", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void btncrearventa_Click(object sender, EventArgs e)
        {
            ...
            Venta oVenta = new Venta()
            {
                ...
                NombreCliente = txtdocumentocliente.Text,
            ...
            if (respuesta)
            {
                var result = MessageBox.Show("Numero de venta generada:\n" + numeroDocumento + "\n\n¿Desea comprar al portapapeles?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
